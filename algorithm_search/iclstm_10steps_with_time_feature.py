...
visualization_path = 'visualization/iclstm_10steps_with_time_feature/'
os.makedirs(visualization_path, exist_ok=True)
test_result_path = 'visualization/iclstm_10steps_with_time_feature/test_result.txt'
model_path = 'visualization/iclstm_10steps_without_time_feature/iclstm_10steps_with_time_feature.h5'
# 配置
sequence_length = 10 
epochs = 200

input = ['Z01_T','Z02_T','Z03_T','Z04_T','Z05_T','Z06_T','Z07_T','Z08_T','Bd_FracCh_Bat','Fa_Pw_Prod','Fa_E_All','Fa_E_HVAC','Ext_T','Ext_Irr','PV_Gen_corrected','Month','Day','Hour','Minute','P1_T_Thermostat_sp_out','P2_T_Thermostat_sp_out','P3_T_Thermostat_sp_out','P4_T_Thermostat_sp_out','Bd_Pw_Bat_sp_out']
predict_columns = ['Z01_T','Z02_T','Z03_T','Z04_T','Z05_T','Z06_T','Z07_T','Z08_T','Bd_FracCh_Bat','Fa_Pw_Prod','Fa_E_All','Fa_E_HVAC','Ext_T','Ext_Irr','PV_Gen_corrected','Month','Day','Hour','Minute']
